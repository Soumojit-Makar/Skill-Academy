    ...
    <footer className="bg-slate-700 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 py-4 grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mb-1.5 cursor-pointer">
            <Phone className="inline-block mr-1" size={16} color="white" />{" "}
          ...
          <p className="text-sm text-slate-400 cursor-pointer">
            ...
            Digital Indian EN-9, Sector V,Salt Lake Kolkata, West Bengal India -
            700091
          </p>
